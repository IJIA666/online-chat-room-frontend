    ...
    <div class="abs cover container">
      <div class="abs cover pnl">
        <div class="top pnl-head" style="padding: 20px ; color: white;">
          ...
          <!-- 退出按钮 -->
          <button @click="exitChat" style="position: absolute; top: 20px; right: 20px; background-color: red; color: white; padding: 10px; border-radius: 5px;">退出聊天</button>
        </div>
        <!--聊天区开始-->
...
const exitChat = () => {
  ...
  // 跳转到登录页面
  router.push({ name: 'Login' })  // 路由跳转到登录页面

  ElMessage.success('已退出聊天')
}
</script>
